...
import {
    ...
    ErrorCategory,
    TelemetryErrorPropertiesClassification
...
type StrictPropertyCheck<TEvent, TClassifiedEvent, TError> = keyof TEvent extends keyof TClassifiedEvent
...
type PropertyUnion = IEventNamePropertyMapping | IEventNamePropertyClassificationMapping;
type PropertyKeys = KeysOfUnion<PropertyUnion>;
...
export function publicLog2<
    K extends PropertyKeys,
    P extends IEventNamePropertyMapping,
    PT extends IEventNamePropertyClassificationMapping
>(
    eventName: K,
    properties?: StrictPropertyCheck<P[K], PT[K], 'Type of classified event does not match event properties'> & {
    ...
    return sendTelemetryEvent(eventName as any, durationMs, properties, ex, sendOriginalEventWithErrors);
}
export function sendTelemetryEvent<P extends IEventNamePropertyMapping, E extends keyof P>(
    ...
    if (
        ...
        sendTelemetryEventInternal<P, E>(eventName, durationMs, properties, ex, sendOriginalEventWithErrors);
    }
}
...
interface IGDPRProperty {
    readonly [name: symbol]: IPropertyData | undefined;
}

// Map all events to their classifications
export interface IEventNamePropertyClassificationMapping extends Record<Telemetry, IGDPRProperty | undefined> {
    /**
    ...
    [EventName.EXTENSION_LOAD]: {
         ...
         */
        workspaceFolderCount: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    /**
    ...
    [EventName.ENVFILE_WORKSPACE]: {
         ...
         */
        hasCustomEnvPath: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    /**
    ...
    [EventName.HASHED_PACKAGE_NAME]: {
         ...
         * @type {string}
         */
        hashedNamev2: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    ...
    [Telemetry.PythonKerneExecutableMatches]: {
        match: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        kernelConnectionType: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    /**
    ...
    [Telemetry.InterpreterListingPerf]: {
         ...
         */
        firstTime?: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    ...
    [Telemetry.HashedCellOutputMimeType]: {
         ...
         * @type {string}
         */
        hashedName: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        hasText: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        hasLatex: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        hasHtml: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        hasSvg: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        hasXml: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        hasJson: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        hasImage: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        hasGeo: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        hasPlotly: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        hasVega: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        hasWidget: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        hasJupyter: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        hasVnd: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    ...
    [Telemetry.GetActivatedEnvironmentVariables]: {
         ...
         */
        envType?: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        /**
         ...
         */
        pythonEnvType?: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        /**
    ...
    [EventName.PYTHON_INTERPRETER_ACTIVATION_ENVIRONMENT_VARIABLES]: {
         ...
         * @type {boolean}
         */
        hasEnvVars?: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        /**
         ...
         * @type {boolean}
         */
        activatedInTerminal?: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        /**
         ...
         * @type {boolean}
         */
        activatedByWrapper?: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    /**
    ...
    [EventName.JUPYTER_EXPERIMENTS_OPT_IN_OUT]: {
         ...
         */
        expNameOptedInto?: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        /**
         * Carries the name of the experiment user has been opted out of manually
         */
        expNameOptedOutOf?: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    ...
    [Telemetry.ConnectFailedJupyter]: TelemetryErrorPropertiesClassification;
    ...
    [Telemetry.ConnectRemoteFailedJupyter]: TelemetryErrorPropertiesClassification;
    ...
    [Telemetry.DataScienceSettings]: never | undefined;
    ...
    [Telemetry.FindJupyterCommand]: { command: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' } };
    ...
    [Telemetry.ExecuteCellPerceivedCold]:
        | undefined
        | { notebook: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' } };
    /**
    ...
    [Telemetry.ClickedExportNotebookAsQuickPick]: {
        format: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    [Telemetry.ExportNotebookAs]: {
        ...
        opened?: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    ...
    [Telemetry.ImportNotebook]: { scope: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' } };
    [Telemetry.Interrupt]: never | undefined;
    [Telemetry.InterruptJupyterTime]: never | undefined;
    [Telemetry.NotebookRunCount]: { count: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' } };
    [Telemetry.NotebookOpenCount]: { count: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' } };
    [Telemetry.NotebookOpenTime]: never | undefined;
    ...
    [Telemetry.OpenNotebook]: { scope: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' } };
    ...
    [Telemetry.JupyterCommandSearch]: {
        where: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        command: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    ...
    [Telemetry.PythonModuleInstall]: {
        moduleName: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        /**
         ...
         */
        isModulePresent?: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        action: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        resourceType?: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        /**
         ...
         */
        resourceHash?: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        pythonEnvType?: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    /**
    ...
    [Telemetry.SetJupyterURIUIDisplayed]: {
         ...
         */
        commandSource: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    [Telemetry.SetJupyterURIToLocal]: never | undefined;
    [Telemetry.SetJupyterURIToUserSpecified]: {
        azure: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    [Telemetry.ShiftEnterBannerShown]: never | undefined;
    [Telemetry.StartShowDataViewer]: never | undefined;
    [Telemetry.ShowDataViewer]: {
        rows: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        columns: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    ...
    [Telemetry.JupyterStartTimeout]: {
         ...
         * @type {number}
         */
        timeout: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    ...
    [Telemetry.VariableExplorerToggled]: {
        open: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        runByLine: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    [Telemetry.VariableExplorerVariableCount]: {
        variableCount: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    [Telemetry.WaitForIdleJupyter]: never | undefined;
    [Telemetry.WebviewStartup]: { type: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' } };
    ...
    [Telemetry.SelectJupyterInterpreter]: {
         ...
         */
        result?: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    ...
    [Telemetry.FindKernelForLocalConnection]: {
         ...
         * @type {boolean}
         */
        kernelSpecFound: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        /**
         * Whether an interpreter was found.
         *
         * @type {boolean}
         */
        interpreterFound: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        /**
         * Whether user was prompted to select a kernel spec.
         *
         * @type {boolean}
         */
        promptedToSelect?: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    /**
    ...
    [Telemetry.KernelSpecLanguage]: {
         ...
         */
        usesShell?: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    /**
    ...
    [Telemetry.KernelEnumeration]: {
         ...
         */
        isPython: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        /**
     ...
     */
    [Telemetry.KernelLauncherPerf]: TelemetryErrorPropertiesClassification;
    /**
    ...
    [Telemetry.PreferredKernel]: {
        ...
        language: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        resourceType: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        hasActiveInterpreter?: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    /**
    ...
    [Telemetry.JupyterInstallFailed]: {
         ...
         */
        product: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    /**
     ...
     * @memberof IEventNamePropertyMapping
     */
    [Telemetry.UserInstalledModule]: { product: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' } };
    /**
    ...
    [Telemetry.HashedIPyWidgetNameUsed]: {
         ...
         */
        cdnSearched: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    /**
    ...
    [Telemetry.IPyWidgetLoadSuccess]: {
        moduleHash: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        moduleVersion: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    /**
     * Telemetry event sent when an ipywidget module fails to load. Module name is hashed.
     */
    [Telemetry.IPyWidgetLoadFailure]: {
        isOnline: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        moduleHash: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        moduleVersion: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        // Whether we timedout getting the source of the script (fetching script source in extension code).
        timedout: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    /**
     ...
     */
    [Telemetry.IPyWidgetLoadDisabled]: {
        moduleHash: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        moduleVersion: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    /**
    ...
    [Telemetry.DiscoverIPyWidgetNamesCDNPerf]: {
        ...
        cdn: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        // Whether we managed to find the widget on the CDN or not.
        exists: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    /**
    ...
    [Telemetry.IPyWidgetPromptToUseCDNSelection]: {
        selection: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    /**
     * Telemetry event sent to indicate the overhead of syncing the kernel with the UI.
     */
    [Telemetry.IPyWidgetOverhead]: {
        totalOverheadInMs: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        numberOfMessagesWaitedOn: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        averageWaitTime: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        numberOfRegisteredHooks: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    /**
    ...
    [Telemetry.IPyWidgetUnhandledMessage]: {
        msg_type: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    ...
    [Telemetry.RawKernelInfoResonse]: {
         ...
         */
        attempts: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
        /**
         * Whether we timedout while waiting for response for Kernel info request.
         */
        timedout: { classification: 'SystemMetadata'; purpose: 'PerformanceAndHealth' };
    };
    [Telemetry.JupyterCreatingNotebook]: TelemetryErrorPropertiesClassification;
